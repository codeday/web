...
// .spec.md §4.9 — rewritten from a yellow.100/yellow.800 mode-toggle
...
// ends.
export const Highlight = React.forwardRef<HTMLElement, React.ComponentProps<typeof Text>>((props, ref) => (
  <Text
    as="span"
    ref={ref as any}
    fontWeight="bold"
