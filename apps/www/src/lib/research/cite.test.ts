...
const POSTER: Publication = {
  ...
  authors: [
    { name: "Alexander Parra", codeDayAffiliated: false },
    { name: "Mingjie Jiang", codeDayAffiliated: false },
    { name: "Tyler Menezes", codeDayAffiliated: true },
  ],
...
const JOURNAL_PAPER: Publication = {
  ...
  authors: [{ name: "Tyler Menezes", codeDayAffiliated: true }],
  venue: "ACM TOSEM",
...
const DATASET_NO_VENUE: Publication = {
  ...
  authors: [
    { name: "Utsab Saha", codeDayAffiliated: false },
    { name: "Tyler Menezes", codeDayAffiliated: true },
  ],
  venue: "",
  venueLong: "",
