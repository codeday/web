...
import { Badge, Box, Button, Grid, Heading, Link, Text } from "@codeday/topo/Atom";
import { Content, Html } from "@codeday/topo/Molecule";
    ...
    <Page slug={`/e/${id}`} title={event.title}>
      ...
      <Content mt={-8}>
        <Grid templateColumns="3fr 2fr" mb={4}>
          ...
          <Box textAlign="right">{type && <Badge variant="outline">{type}</Badge>}</Box>
        </Grid>
